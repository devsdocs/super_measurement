...
sealed class Power extends Unit<Power> {
  ...
  static const values = [
    ...
    horsepowerWater,
    pferdestarkePs,
    bTUPerHourInternational,
    bTUPerMinuteInternational,
    bTUPerSecondInternational,
    bTUPerHourThermochemical,
    bTUPerMinuteThermochemical,
    bTUPerSecondThermochemical,
    mBTUPerHour,
    mBH,
    tonRefrigeration,
