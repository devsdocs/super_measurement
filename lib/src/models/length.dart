...
sealed class Length extends Unit<Length> {
  ...
  static const valuesAsMap = EnumValues({
    ...
    Length$Gigameter._minorName: gigameter,
    Length$Megameter._minorName: megameter,
    Length$Kilometer._minorName: kilometer,
    Length$Hectometer._minorName: hectometer,
    Length$Dekameter._minorName: dekameter,
    Length$Meter._minorName: meter,
    Length$Decimeter._minorName: decimeter,
    Length$Centimeter._minorName: centimeter,
    Length$Millimeter._minorName: millimeter,
    Length$Micrometer._minorName: micrometer,
    Length$Nanometer._minorName: nanometer,
    Length$Picometer._minorName: picometer,
    Length$Femtometer._minorName: femtometer,
    Length$Attometer._minorName: attometer,
    Length$Angstrom._minorName: angstrom,
    Length$Fermi._minorName: fermi,
    Length$Planck._minorName: planck,
    Length$MileUS._minorName: mileUS,
    Length$MileUSSurveyFoot._minorName: mileUSSurveyFoot,
    Length$MileRoman._minorName: mileRoman,
    Length$Furlong._minorName: furlong,
    Length$Chain._minorName: chain,
    Length$Rod._minorName: rod,
    Length$Perch._minorName: perch,
    Length$Pole._minorName: pole,
    Length$Fathom._minorName: fathom,
    Length$Yard._minorName: yard,
    Length$Foot._minorName: foot,
    Length$FootUSSurvey._minorName: footUSSurvey,
    Length$Link._minorName: link,
    Length$Inch._minorName: inch,
    Length$Hand._minorName: hand,
    Length$Mil._minorName: mil,
    Length$MilSweden._minorName: milSweden,
    Length$Microinch._minorName: microinch,
    Length$Megaparsec._minorName: megaparsec,
    Length$Kiloparsec._minorName: kiloparsec,
    Length$Parsec._minorName: parsec,
    Length$LightYear._minorName: lightYear,
    Length$AstronomicalUnit._minorName: astronomicalUnit,
    Length$League._minorName: league,
    Length$NauticalMile._minorName: nauticalMile,
    Length$Arpent._minorName: arpent,
    Length$Pica._minorName: pica,
    Length$Point._minorName: point,
    Length$Twip._minorName: twip,
    Length$Aln._minorName: aln,
    Length$Famn._minorName: famn,
    Length$Caliber._minorName: caliber,
    Length$Ken._minorName: ken,
    Length$Barleycorn._minorName: barleycorn,
    Length$RussianArchin._minorName: russianArchin,
    Length$RomanActus._minorName: romanActus,
    Length$ClothNail._minorName: clothNail,
    Length$ClothSpan._minorName: clothSpan,
    Length$VaraDeTarea._minorName: varaDeTarea,
    Length$VaraConuquera._minorName: varaConuquera,
    Length$VaraCastellana._minorName: varaCastellana,
    Length$CubitGreek._minorName: cubitGreek,
    Length$LongReedBiblical._minorName: longReedBiblical,
    Length$ReedBiblical._minorName: reedBiblical,
    Length$CubitBiblical._minorName: cubitBiblical,
    Length$LongCubitBiblical._minorName: longCubitBiblical,
    Length$SpanBiblical._minorName: spanBiblical,
    Length$HandbreadthBiblical._minorName: handbreadthBiblical,
    Length$FingerbreadthBiblical._minorName: fingerbreadthBiblical,
  });
}
