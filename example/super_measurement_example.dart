...
void exampleOfLength() {
  ...
  print('1 Kilometers + 1 Furlongs = ${const Kilometers(1) + const Furlongs(1)}');
...
void exampleOfPower() {
  ...
  print('1 Horsepower + 1 Kilowatt = ${const Horsepower(1) + const Kilowatt(1)}');
...
void exampleOfSpeed() {
  ...
  print('1 KilometerPerHour + 1 Knot = ${const KilometerPerHour(1) + const Knot(1)}');
  print(
